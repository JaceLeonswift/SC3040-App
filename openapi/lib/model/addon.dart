...
class Addon {
  ...
  @override
  String toString() => 'Addon[id=$id, name=$name, homePage=$homePage, themeColorCode=$themeColorCode, imageSet=$imageSet]';
  ...
  static Map<String, List<Addon>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = Addon.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
